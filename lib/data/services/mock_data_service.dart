  ...
  static List<LaundretteBranch> getMockBranches() {
    return [
      LaundretteBranch(
        ...
        description: 'Premium laundry services in downtown',
        address: '123 Business St, New York, NY 10001',
        city: 'New York',
        postcode: '10001',
        phone: '+1-555-0123',
        ...
        services: ['wash', 'dry', 'iron', 'dry_clean', 'express'],
        operatingHours: {
          'monday': '08:00-20:00',
          'tuesday': '08:00-20:00',
      ...
      LaundretteBranch(
        id: 'branch_2',
        name: 'Uptown Branch',
        description: 'Fast and reliable laundry in uptown',
      ...
      LaundretteBranch(
        id: 'branch_3',
        name: 'Family Laundry',
        description: 'Family-friendly laundry services',
        address: '456 Private Ave, Los Angeles, CA 90210',
        city: 'Los Angeles',
        postcode: '90210',
        phone: '+1-555-0125',
        email: 'family@cleanfresh.com',
        status: BranchStatus.active,
        ...
        latitude: 34.0522,
        longitude: -118.2437,
        images: ['https://example.com/branch3.jpg'],
